class SwiftVersionCommand < Clamp::Command
    ...
    def execute
        ...
        ProjectMod.apply_build_setting(name: 'SWIFT_VERSION', value: '4.0', target_names: target_list)
        
        targets_string = target_list.nil? 'All targets' : target_list.join(", ") + " targets"
